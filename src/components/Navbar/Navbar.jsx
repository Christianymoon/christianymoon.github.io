  ...
  return (
    ...
    >
      <g id="Capa_x0020_1">
        <g id="_1566764992992">
          <g>
            <polygon fill="currentColor" points="-0,0.77 407.2,815.17 488.36,673.17 151.68,0.77" />
            <path
              fill="currentColor"
          ...
          />
          <polygon fill="currentColor" points="2493.47,385.23 2453.21,345.27 2453.21,587.46 2453.21,587.46 2493.47,546.89" />
          <path
            fill="currentColor"
          ...
          />
          <polygon fill="currentColor" points="3316.9,385.23 3276.64,345.27 3276.64,587.46 3276.64,587.46 3316.9,546.89" />
          <path
            fill="currentColor"
          ...
          />
          <polygon fill="currentColor" points="4298.05,345.27 4419.15,587.46 4441.85,542.35 4343.16,345.27" />
          <path
            fill="currentColor"
...
export function Navbar(props) {
  ...
  return (
    <nav className="px-4 py-4 w-full md:px-6 md:py-6 sticky top-0 z-50 backdrop-blur-md bg-black/60 border-b border-purple-900/30">
      <div className="flex items-center justify-between md:justify-between">
        <div className="w-10 md:hidden" />

        <Link href="/" className="flex-shrink-0 md:flex-shrink-0 text-white hover:text-purple-400 transition-colors duration-300 drop-shadow-[0_0_8px_rgba(168,85,247,0.5)]">
          <BrandLogo />
        </Link>
        ...
        <div className="hidden md:flex items-center gap-2">
          {links.map((link, index) => (
            <Link
              key={index}
              className="nav-link flex p-2 text-purple-400 md:flex-row md:px-2 hover:text-purple-400 transition-all duration-300 hover:scale-105 hover:drop-shadow-[0_0_5px_rgba(168,85,247,0.8)]"
              to={link.href}
            >
              {link.name}
            </Link>
        ...
        <button
          className="md:hidden hover:cursor-pointer text-purple-400 p-2 hover:text-purple-300 transition-colors"
      ...
      {isOpen && (
        <div id="mobile-menu" className="md:hidden mt-4 flex flex-col items-center gap-2 bg-black/95 rounded-lg p-4 border border-purple-900/50 backdrop-blur-xl absolute w-[calc(100%-2rem)] left-4 top-16 z-50 shadow-[0_0_15px_rgba(147,51,234,0.3)]">
          {links.map((link, index) => (
            <Link
              key={index}
              className="nav-link flex p-2 text-purple-400 hover:text-purple-400 transition-colors w-full text-center hover:bg-purple-900/20 rounded"
              to={link.href}
