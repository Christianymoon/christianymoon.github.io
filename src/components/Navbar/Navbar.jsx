  ...
  return (
    ...
    >
      <g id="Capa_x0020_1">
        <g id="_1566764992992">
          <g>
            <polygon fill="white" points="-0,0.77 407.2,815.17 488.36,673.17 151.68,0.77" />
            <path
              fill="white"
          ...
          />
          <polygon fill="white" points="2493.47,385.23 2453.21,345.27 2453.21,587.46 2453.21,587.46 2493.47,546.89" />
          <path
            fill="white"
          ...
          />
          <polygon fill="white" points="3316.9,385.23 3276.64,345.27 3276.64,587.46 3276.64,587.46 3316.9,546.89" />
          <path
            fill="white"
          ...
          />
          <polygon fill="white" points="4298.05,345.27 4419.15,587.46 4441.85,542.35 4343.16,345.27" />
          <path
            fill="white"
...
export function Navbar(props) {
  ...
  return (
    <nav className="px-4 py-4 w-full md:px-6 md:py-6">
      <div className="flex items-center justify-between md:justify-between">
        <div className="w-10 md:hidden" />

        <Link href="/" className="flex-shrink-0 md:flex-shrink-0">
          <BrandLogo />
        </Link>
        ...
        <div className="hidden md:flex items-center gap-2">
          {links.map((link, index) => (
            <Link
              key={index}
              className="nav-link flex p-2 text-white md:flex-row md:px-2 hover:text-white/80 transition-colors"
              to={link.href}
            >
              {link.name}
            </Link>
      ...
      {isOpen && (
        <div className="md:hidden mt-4 flex flex-col items-center gap-2">
          {links.map((link, index) => (
            <Link
              key={index}
              className="nav-link flex p-2 text-white hover:text-white/80 transition-colors"
              to={link.href}
